...
fn match_args_from_caller_to_enzyme<'ll, 'tcx>(
    ...
    let global_dupnoneed = cx.declare_global("enzyme_dupnoneed", cx.type_ptr_ext(AddressSpace::ZERO));
    let global_dupnoneedv = cx.declare_global("enzyme_dupnoneedv", cx.type_ptr_ext(AddressSpace::ZERO));
...
pub(crate) fn generate_enzyme_call<'ll, 'tcx>(
    ...
    let global_primal_ret = cx.declare_global("enzyme_primal_return", cx.type_ptr_ext(AddressSpace::ZERO));
