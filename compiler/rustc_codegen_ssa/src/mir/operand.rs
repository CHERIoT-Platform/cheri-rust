    ...
    fn from_const_alloc<Bx: BuilderMethods<'a, 'tcx, Value = V>>(
        ...
        match layout.backend_repr {
            ...
            BackendRepr::ScalarPair(
                ...
                let b_offset = (offset + a.in_memory_size(bx)).align_to(b.default_align(bx).abi);
            ...
            let (in_scalar, imm) = match (self.val, self.layout.backend_repr) {
                ...
                (OperandValue::Pair(a_llval, b_llval), BackendRepr::ScalarPair(a, b)) => {
                    if offset.bytes() == 0 {
                        ...
                        assert_eq!(
                            offset,
                            a.in_memory_size(bx.cx()).align_to(b.default_align(bx.cx()).abi)
                        );
    ...
    pub(crate) fn store_with_flags<Bx: BuilderMethods<'a, 'tcx, Value = V>>(
        ...
        match self {
            ...
            OperandValue::Pair(a, b) => {
                ...
                let b_offset = a_scalar.in_memory_size(bx).align_to(b_scalar.default_align(bx).abi);
