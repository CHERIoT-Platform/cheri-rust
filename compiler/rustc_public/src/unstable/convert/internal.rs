...
impl RustcInternal for Abi {
    ...
    fn internal<'tcx>(
        ...
        match *self {
            ...
            Abi::CHERIoTCompartmentCall => rustc_abi::ExternAbi::CHERIoTCompartmentCall,
            Abi::CHERIoTCompartmentCallee => rustc_abi::ExternAbi::CHERIoTCompartmentCallee,
            Abi::CHERIoTLibraryCall => rustc_abi::ExternAbi::CHERIoTLibraryCall,
